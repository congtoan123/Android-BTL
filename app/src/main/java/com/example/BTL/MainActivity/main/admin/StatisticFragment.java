...
public class StatisticFragment extends SupportFragment implements OnCompleteListener<QuerySnapshot>, OnFailureListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        spinner.setAdapter(new ArrayAdapter<String>(getContext(),R.layout.item_spinner,getResources().getStringArray(R.array.statistic)));
